...
def approachActivation():
    activatedBnW = True
    activatedCOK = False
    ActivatedRandom = False
    return [activatedBnW, activatedCOK, ActivatedRandom]
...
if __name__ == '__main__':
    ...
    for parameters in [(0.05, 0.05, 0.05, 0.05), (0.05, 0.05, 0.05, 0.1), (0.05, 0.05, 0.05, 0.2)]:
